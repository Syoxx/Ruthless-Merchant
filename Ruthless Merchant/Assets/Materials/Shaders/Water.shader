    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float2 node_1527 = float2(((node_2543.r*_FlowSpeed.r)+o.uv0.r),(o.uv0.g+(node_2543.r*_FlowSpeed.g)));
                float4 _NoiseTex2 = tex2Dlod(_Noise,float4(TRANSFORM_TEX(node_1527, _Noise),0.0,0));
                float4 node_7015 = _Time;
                float node_3503 = ((sin(((_NoiseTex2.r*3.141592654*4.0)+(node_7015.g*_Wave_speed)))/2.0)+0.5);
                float node_5396 = saturate(node_3503);
                v.vertex.xyz += ((node_5396*_WaveStrength)*v.normal*pow(abs(v.normal.g),2.0));
...
////// Emissive:
                ...
                float4 node_2543 = _Time;
                float2 node_1527 = float2(((node_2543.r*_FlowSpeed.r)+i.uv0.r),(i.uv0.g+(node_2543.r*_FlowSpeed.g)));
