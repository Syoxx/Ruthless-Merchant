...
////// Emissive:
                ...
                float node_7993 = 6.0;
                float3 finalColor = emissive + lerp(floor(min(1.0,node_3747) * node_7993) / (node_7993 - 1),node_3747,_PosterizeEffect);
...
////// Lighting:
                ...
                float3 node_3747 = ((node_544*max(0,dot(lightDirection,i.normalDir)))*_PosterizeMultiplier*_LightColor0.rgb*attenuation); // Attenuate and Color
                float node_7993 = 6.0;
                float3 finalColor = lerp(floor(min(1.0,node_3747) * node_7993) / (node_7993 - 1),node_3747,_PosterizeEffect);
