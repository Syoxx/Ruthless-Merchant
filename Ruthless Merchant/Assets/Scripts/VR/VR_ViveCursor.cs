...
public class VR_ViveCursor : MonoBehaviour
{
    // Get controller axis
    ...
    [SerializeField, Tooltip("Thickness of the laser pointer casted out of the controller..")]
    public float thickness = 0.002f;

    [SerializeField, Tooltip("Length of the laser pointer casted out of the controller.")]
    ...
    void SetPointerTransform(float setLength, float setThicknes)
    {
        ...
        else
        {
            ...
            if (showCursor)
            {
                cursor.transform.localPosition = new Vector3(90f, 0f, setLength - cursor.transform.localScale.z);
            }
        }
    }
