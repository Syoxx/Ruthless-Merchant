...
namespace RuthlessMerchant
{
    public class Player : Character
    {
        ...
        //NOTE: Show Map Input with Key M
        public void ShowMap()
        {
